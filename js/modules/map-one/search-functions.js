...
function geoSrch() {
  ...
  var $boroChoice = $('.srchDrpBoro');
  //$selectedChoice.empty();
  $.each(boroResult, function (key, value) {
    $boroChoice.append(
      '<div class = option><input type=radio class="radio srchSlctBoro" value='+value+'><label for ='+key+'>' + key +'</label></div>');
      });
  ...
  var congdistChoice = $('.srchDrpCongDist');
  //$selectedChoice.empty();
  $.each(congdistValues, function (index, value) {
    congdistChoice.append(
      '<div class = option><input type=radio class="radio srchSlctCongDist" value='+value+'><label>' + value +'</label></div>');
      });  
  ...
  var $zctaChoice = $('.srchDrpZCTA');
  //$selectedChoice.empty();
  $.each(zctaResult, function (key, value) {
    $zctaChoice.append(
      '<div class = option><input type=radio class="radio srchSlctZCTA" value='+value+'><label for ='+key+'>' + key +'</label></div>');
      });  
  ...
  var $ntaChoice = $('.srchDrpNTA');
  //$selectedChoice.empty();
  $.each(ntaResult, function (key, value) {
    $ntaChoice.append(
      '<div class = option><input type=radio class="radio srchSlctNTA" value='+value+'><label for ='+key+'>' + key +'</label></div>');
      }); 
  ...
  var $ntaBKChoice = $('.srchDrpNTABK');
  //$selectedChoice.empty();
  $.each(ntaBKResult, function (key, value) {
    $ntaBKChoice.append(
      '<div class = option><input type=radio class="radio srchSlctNTABK" value='+value+'><label for ='+key+'>' + key +'</label></div>');
      }); 
  ...
  var $ntaQNChoice = $('.srchDrpNTAQN');
  //$selectedChoice.empty();
  $.each(ntaQNResult, function (key, value) {
    $ntaQNChoice.append(
      '<div class = option><input type=radio class="radio srchSlctNTAQN" value='+value+'><label for ='+key+'>' + key +'</label></div>');
      });  
  ...
  var $ntaMNChoice = $('.srchDrpNTAMN');
  //$selectedChoice.empty();
  $.each(ntaMNResult, function (key, value) {
    $ntaMNChoice.append(
      '<div class = option><input type=radio class="radio srchSlctNTAMN" value='+value+'><label for ='+key+'>' + key +'</label></div>');
      }); 
  ...
  var $ntaBXChoice = $('.srchDrpNTABX');
  //$selectedChoice.empty();
  $.each(ntaBXResult, function (key, value) {
    $ntaBXChoice.append(
      '<div class = option><input type=radio class="radio srchSlctNTABX" value='+value+'><label for ='+key+'>' + key +'</label></div>');
      });   
...
var $ntaSIChoice = $('.srchDrpNTASI');
//$selectedChoice.empty();
$.each(ntaSIResult, function (key, value) {
  $ntaSIChoice.append(
    '<div class = option><input type=radio class="radio srchSlctNTASI" value='+value+'><label for ='+key+'>' + key +'</label></div>');
    });   
